      ...
      {popoverVisible && (
        <div className="popover">
          ...
          <ActionItem
            ...
            suffix={isWindows() ? "Ctrl+Shift+'" : "âŒ˜â‡§'"}
            onClick={() => {
              if (editor) {
