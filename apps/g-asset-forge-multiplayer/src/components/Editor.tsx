...
import { throttle } from '@g-asset-forge/common';
import { GAssetForgeEditor } from '@g-asset-forge/core';
...
const Editor: FC = () => {
  ...
  const initEditor = (fileId: string) => {
    ...
    const GAssetForgeBinding = joinRoom(editor, fileId, userInfo.current!);
    setAwarenessClientId(GAssetForgeBinding.awareness.clientID);
    GAssetForgeBinding.on('usersChange', setUsers);
