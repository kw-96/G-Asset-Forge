...
import { Select } from '@g-asset-forge/components';
import { DEFAULT_PAINTS, type IPaint, PaintType } from '@g-asset-forge/core';
import { CloseOutlined } from '@g-asset-forge/icons';
...
export const PaintPicker: FC<IProps> = ({
  ...
  return (
    <div className="g-asset-forge-paint-picker">
      <div className="paint-picker-header">
        ...
        />
        <div
          className="g-asset-forge-close-btn"
          onClick={() => {
            onClose && onClose();
          }}
        >
