...
export class CanvasSystemValidator {
     ...
     */
    static async testCanvasCreation(containerId = 'test-canvas-container') {
        try {
    ...
    static async getDiagnostics() {
        ...
        try {
            ...
            if (fabric && fabric.version) {
                diagnostics.fabricjs.version = fabric.version;
            }
        }
        catch (error) {
...
//# sourceMappingURL=CanvasSystemValidator.js.map