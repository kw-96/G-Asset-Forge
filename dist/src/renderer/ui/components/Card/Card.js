...
const StyledCard = styled.div `
  ...
  `}
`;
export const Card = ({ variant = 'default', padding = 'md', hoverable = false, clickable = false, children, className, onClick, }) => {
    return (_jsx(StyledCard, { "$variant": variant, "$padding": padding, "$hoverable": hoverable, "$clickable": clickable, className: className, onClick: onClick, children: children }));
};
// Card子组件
