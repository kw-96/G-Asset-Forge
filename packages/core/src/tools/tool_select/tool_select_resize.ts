import { cloneDeep, isEqual, noop } from '@g-asset-forge/common';
import {
  type IMatrixArr,
  invertMatrix,
  type IPoint,
...
export class SelectResizeTool implements IBaseTool {
  ...
  private childNodeSet = new Set<GAssetForgeGraphics>();
  ...
  private updateSingleGraphics(graphics: GAssetForgeGraphics) {
  ...
  private updateControls = (graphics: GAssetForgeGraphics) => {
