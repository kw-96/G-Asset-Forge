...
import { type IMatrixArr, type IPathItem } from '@g-asset-forge/geo';

import { type IParentIndex, type GAssetForgeGraphics } from '../graphics';
...
export class SetGraphsAttrsCmd implements ICommand {
  ...
  constructor(
    public desc: string,
    private elements: GAssetForgeGraphics[],
