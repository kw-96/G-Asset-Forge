import { parseRGBAStr } from '@g-asset-forge/common';
import { applyMatrix, getPointsBbox, type IPoint, Matrix } from '@g-asset-forge/geo';
...
export class GAssetForgeLine extends GAssetForgeGraphics<LineAttrs> {
