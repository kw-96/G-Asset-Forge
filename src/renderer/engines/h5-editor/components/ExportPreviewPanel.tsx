...
import { 
  ExportOptimizer, 
  type IExportPreviewOptions, 
  type IExportPerformanceMetrics 
} from '../export/ExportOptimizer';
import { type IImageExportOptions } from '../export/ImageExportEngine';
import { type IH5Page } from '../types';

interface IExportPreviewPanelProps {
  sourceCanvas?: HTMLCanvasElement | null;
  currentPage?: IH5Page | null;
  exportOptions: IImageExportOptions;
  onOptionsChange?: (options: IImageExportOptions) => void;
  className?: string;
...
export const ExportPreviewPanel: React.FC<IExportPreviewPanelProps> = ({
  ...
  const [previewOptions, setPreviewOptions] = useState<IExportPreviewOptions>({
  ...
  // 处理预览选项变化
  const handlePreviewOptionChange = (key: keyof IExportPreviewOptions, value: any) => {
