...
interface IBackgroundSettingsPanelProps {
  onBackgroundChange?: (background: IBackgroundSettings) => void;
...
export const BackgroundSettingsPanel: React.FC<IBackgroundSettingsPanelProps> = ({
  ...
  const [currentBackground, setCurrentBackground] = useState<IBackgroundSettings | null>(null);
  const [previewUrl, setPreviewUrl] = useState<string>('');
  const [presets, setPresets] = useState<IBackgroundPreset[]>([]);
