...
import { EnhancedIconButton } from '../../../components/Enhanced/EnhancedIconButton';
import { useUIIntegration, UIFeature } from '../../../components/UIIntegration/UIIntegrationProvider';
    ...
    <PanelContainer>
      ...
      <List>
        {pages.length === 0 ? (
          ...
          pages.map(p => (
            <PageItem key={p.id} $active={!!p.isCurrent} onClick={() => onSelectPage?.(p.id)}>
