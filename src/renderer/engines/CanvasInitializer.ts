...
export class CanvasInitializer {
  private static instance: CanvasInitializer | null = null;
  private initializedSystems: Map<string, CanvasSystemComponents> = new Map();
   ...
   */
  async initializeCanvasSystem(options: CanvasInitializationOptions): Promise<CanvasSystemComponents> {
    const {
      containerId,
      width,
      height,
    ...
    try {
      ...
      const systemComponents: CanvasSystemComponents = {
        canvas,
        canvasEngine,
        memoryManager,
        viewControl,
   ...
   */
  private applyInitialOptimizations(canvas: fabric.Canvas): void {
   ...
   */
  private validateOptions(options: CanvasInitializationOptions): void {
