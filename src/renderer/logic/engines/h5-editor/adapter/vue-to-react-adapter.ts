...
export interface VueToReactAdapterOptions {
...
export class VueComponentWrapper {
  ...
  constructor(
    ...
    private props: VueComponentProps = {},
    private options: VueToReactAdapterOptions = {}
  ) {}
   ...
   * 更新Vue组件的props
   */
  updateProps(newProps: VueComponentProps): void {
...
export class VueToReactAdapter {
  ...
  constructor(options: VueToReactAdapterOptions = {}) {
    this.options = {
  ...
  createReactComponent(
    ...
    displayName?: string
  ): React.ComponentType<VueComponentProps> {
    const adapter = this;
    const componentOptions = this.options;

    return class VueInReact extends React.Component<VueComponentProps> {
      ...
      constructor(props: VueComponentProps) {
        super(props);
      ...
      override componentDidUpdate(prevProps: VueComponentProps): void {
  ...
  ): Record<string, React.ComponentType<VueComponentProps>> {
    const reactComponents: Record<string, React.ComponentType<VueComponentProps>> = {};
  ...
  getStats(): {
    ...
    totalCreated: number;
    options: VueToReactAdapterOptions;
  } {
    return {
