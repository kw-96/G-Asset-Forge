...
import { type ImageExportProgress, type ImageExportResult } from '../export/ImageExportEngine';

interface ExportProgressPanelProps {
  isExporting: boolean;
  progress?: ImageExportProgress | null;
  result?: ImageExportResult | null;
  suggestions?: ExportOptimizationSuggestion[];
  metrics?: ExportPerformanceMetrics | null;
  onCancel?: () => void;
  onRetry?: () => void;
  onApplySuggestion?: (suggestion: ExportOptimizationSuggestion) => void;
  className?: string;
...
export const ExportProgressPanel: React.FC<ExportProgressPanelProps> = ({
  ...
  // 获取建议的图标和颜色
  const getSuggestionStyle = (suggestion: ExportOptimizationSuggestion) => {
