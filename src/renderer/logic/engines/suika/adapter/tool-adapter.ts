...
import { Tool, ToolType, ToolConfig, ToolProperties } from '../../../core/tools/tool-types';
...
export class SuikaToolAdapter {
  ...
  */
   ...
   * 创建工具包装器
   */
  private createToolWrapper(type: ToolType): Tool | null {
    const config = TOOL_CONFIGS[type];
  ...
  */
   ...
   * 将属性同步到Suika编辑器
   */
  private syncPropertiesToSuika(_properties: Partial<ToolProperties>): void {
    // TODO: 根据工具类型同步相应的属性
