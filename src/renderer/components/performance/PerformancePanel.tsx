...
import { unifiedPerformanceMonitor, UnifiedPerformanceMetrics, PerformanceReport } from '../../utils/performance/UnifiedPerformanceMonitor';
import { startupPerformanceMonitor } from '../../utils/performance/StartupPerformanceMonitor';
import { runtimePerformanceMonitor } from '../../utils/performance/RuntimePerformanceMonitor';
import { NetworkDriveManager } from '../../managers/storage/NetworkDriveManager';
import { performanceTestRunner, PerformanceTestSuite } from '../../utils/performance/PerformanceTestRunner';
...
export const PerformancePanel: React.FC<PerformancePanelProps> = ({ 
  ...
  const [networkDriveManager, setNetworkDriveManager] = useState<NetworkDriveManager | null>(null);
  ...
  useEffect(() => {
    const initNetworkDriveManager = async () => {
      try {
        ...
        const manager = new NetworkDriveManager(userDataPath);
