...
import { type IAdvancedFilter } from '../../managers/assets/AssetSearchEngine';
      ...
      <div style={{ padding: '12px 16px', borderBottom: '1px solid #e0e0e0' }}>
        <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap' }}>
          ...
          {['free', 'premium', 'custom'].map(license => (
            <button
              key={license}
              onClick={() => handleLicenseToggle(license as any)}
              style={{
                padding: '4px 8px',
                border: `1px solid ${currentFilter.license?.includes(license as any) ? '#17a2b8' : '#ddd'}`,
                backgroundColor: currentFilter.license?.includes(license as any) ? '#17a2b8' : 'white',
